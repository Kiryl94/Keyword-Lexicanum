...
- [x] 1.2 GitHub repository exists and contains latest code
- [x] 1.3 Vercel project linked to GitHub repo
- [x] 1.4 First Vercel deployment status is Ready
- [x] 1.5 Preview URL loads `/` in desktop browser

### Phase 2: Deploy Config & Documentation

#### Automated

- [x] 2.1 Local build passes: `npm run build`
- [x] 2.2 Type checking passes: `npm run typecheck`
- [x] 2.3 Linting passes: `npm run lint`

#### Manual

- [x] 2.4 README Deploy section matches actual Vercel settings
- [x] 2.5 Preview URL recorded in change.md Notes

### Phase 3: Smoke Verification

#### Automated

- [x] 3.1 Local build passes: `npm run build`

#### Manual

- [x] 3.2 Preview URL opens on phone browser; nav tabs load
- [x] 3.3 Lookup `advantage` works on preview
- [x] 3.4 WH40k `close quarters` works after system switch
- [x] 3.5 Unknown term shows not-found card
- [x] 3.6 Perceived load time acceptable at table
