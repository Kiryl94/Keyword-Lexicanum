...
- **Pathfinder 2e:** ORC license — public curated manifest (`pf2e-remaster-v7`, 96 keywords).
- **Year Zero Engine:** Free League YZE FTL — public curated manifest (`yze-srd-v8`, 75 keywords).
...
| Pathfinder 2e | SRD | Curated ORC Remaster manifest | Yes (96 keywords) | `npm run corpus:build-pf2e` |
| Year Zero Engine | SRD | Curated YZE FTL manifest | Yes (75 keywords) | `npm run corpus:build-yze` |
