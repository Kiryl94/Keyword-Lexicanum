...
- **Pathfinder 2e:** ORC license — public curated manifest (`pf2e-remaster-v11`, 116 keywords).
- **Year Zero Engine:** Free League YZE FTL — public curated manifest (`yze-srd-v12`, 91 keywords).
...
| Pathfinder 2e | SRD | Curated ORC Remaster manifest | Yes (116 keywords) | `npm run corpus:build-pf2e` |
| Year Zero Engine | SRD | Curated YZE FTL manifest | Yes (91 keywords) | `npm run corpus:build-yze` |
